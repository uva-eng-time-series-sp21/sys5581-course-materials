...
Last week: Reading in, reordering, and merging data
===
...
- For reordering data, use `order()`, `rev()`, and proper indexing 
- For merging data, use `merge()`; but can do it manually using reordering tricks
